...
module CountryService (Target(..),
                       toTarget,
                       targetToCountries,
                       Country(..)) where
{-
  imports for constructing JSON
-}
import           Data.Aeson
